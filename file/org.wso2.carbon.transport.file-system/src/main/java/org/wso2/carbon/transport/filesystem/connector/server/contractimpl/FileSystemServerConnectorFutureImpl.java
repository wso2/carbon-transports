...
/**
 * Implementation of the {@link FileSystemServerConnectorFuture}.
 */
public class FileSystemServerConnectorFutureImpl implements FileSystemServerConnectorFuture {

    private FileSystemListener fileSystemListener;

    public FileSystemServerConnectorFutureImpl(FileSystemListener fileSystemListener) {
        this.fileSystemListener = fileSystemListener;
    }

    @Override
    public void notifyFileSystemListener(FileSystemMessage fileSystemMessage) {
        fileSystemListener.onMessage(fileSystemMessage);
    }
}
